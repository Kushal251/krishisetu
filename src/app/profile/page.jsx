...
export default function ProfilePage() {
  ...
  return <><LoggedInNavbar user={user} /><main className="min-h-screen bg-gray-50 p-5 sm:p-8"><div className="mx-auto max-w-4xl"><div className="flex flex-wrap items-start justify-between gap-4"><div><Link href="/dashboard" className="text-sm font-bold text-green-700">← Back to home</Link><h1 className="mt-3 text-3xl font-black sm:text-4xl">My profile</h1><p className="mt-1 text-gray-600">Your KisanSetu account and seller details.</p></div><div className="rounded-xl bg-green-700 px-4 py-2 font-bold text-white">{niceType(seller?.sellerType || user.role)}</div></div>
